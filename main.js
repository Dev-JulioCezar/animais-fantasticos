...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ animaNumber)\n/* harmony export */ });\nfunction animaNumber() {\n  var numerosAnimal = document.querySelectorAll(\"[data-numero]\");\n  function animaNumeros() {\n    numerosAnimal.forEach(function (item) {\n      var start = 0;\n      var totalAnimal = +item.innerText;\n      var incremento = Math.floor(totalAnimal / 100);\n      var timer = setInterval(function () {\n        start += incremento;\n        item.innerText = start;\n        if (start > totalAnimal) {\n          item.innerText = totalAnimal;\n          clearInterval(timer);\n        }\n      }, 25 * Math.random());\n    });\n  }\n  var observerTarget = document.querySelector(\".numeros\");\n  var observer;\n  function handleMutation(mutation) {\n    if (mutation[0].target.classList.contains(\"ativo\")) {\n      observer.disconnect();\n      animaNumeros();\n    }\n  }\n  observer = new MutationObserver(handleMutation);\n  observer.observe(observerTarget, {\n    attributes: true\n  });\n}\n\n//# sourceURL=webpack://btc-fetch/./js/modules/anima-number.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initAnimaScroll)\n/* harmony export */ });\nfunction initAnimaScroll() {\n  var section = document.querySelectorAll('[data-anime=\"scroll\"]');\n  var windowPosition = window.innerHeight * 0.4;\n  function animaScroll() {\n    section.forEach(function (item) {\n      var itemTop = item.getBoundingClientRect().top;\n      if (itemTop < windowPosition) item.classList.add(\"ativo\");else if (item.classList.contains(\"ativo\")) {\n        item.classList.remove(\"ativo\");\n      }\n    });\n  }\n  if (section.length) {\n    animaScroll();\n    window.addEventListener(\"scroll\", animaScroll);\n  }\n}\n\n//# sourceURL=webpack://btc-fetch/./js/modules/scroll-animation.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initScrollSuave)\n/* harmony export */ });\nfunction initScrollSuave() {\n  var linksInt = document.querySelectorAll(\"[data-anime='menu'] a[href^='#']\");\n  function scrollSection(event) {\n    event.preventDefault();\n    var href = this.getAttribute(\"href\");\n    var section = document.querySelector(href);\n    section.scrollIntoView({\n      behavior: \"smooth\",\n      block: \"start\"\n    });\n\n    // FORMA ALTERNATIVA\n    // const top = section.offsetTop;\n    // window.scrollTo({\n    //   top: top,\n    //   behavior: \"smooth\"\n    // })\n  }\n\n  linksInt.forEach(function (link) {\n    link.addEventListener(\"click\", scrollSection);\n  });\n}\n\n//# sourceURL=webpack://btc-fetch/./js/modules/scroll-suave.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ _asyncToGenerator)\n/* harmony export */ });\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {\n  try {\n    var info = gen[key](arg);\n    var value = info.value;\n  } catch (error) {\n    reject(error);\n    return;\n  }\n  if (info.done) {\n    resolve(value);\n  } else {\n    Promise.resolve(value).then(_next, _throw);\n  }\n}\nfunction _asyncToGenerator(fn) {\n  return function () {\n    var self = this,\n      args = arguments;\n    return new Promise(function (resolve, reject) {\n      var gen = fn.apply(self, args);\n      function _next(value) {\n        asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value);\n      }\n      function _throw(err) {\n        asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err);\n      }\n      _next(undefined);\n    });\n  };\n}\n\n//# sourceURL=webpack://btc-fetch/./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js?");
